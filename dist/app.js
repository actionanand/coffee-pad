...
(function() {
  ...
  CategoryController = (function(superClass) {
  ...
  DocumentController = (function(superClass) {
    extend(DocumentController, superClass);
  ...
  CategoryModel = (function(superClass) {
    extend(CategoryModel, superClass);
  ...
  Router = (function() {
    ...
    Router.call = function() {
      ...
      route = arguments[0], parameters = 2 <= arguments.length ? slice.call(arguments, 1) : [];
  ...
  CategoryListView = (function(superClass) {
    extend(CategoryListView, superClass);
  ...
  DocumentEditorView = (function(superClass) {
    extend(DocumentEditorView, superClass);
  ...
  DocumentItemView = (function(superClass) {
    extend(DocumentItemView, superClass);
  ...
  DocumentListView = (function(superClass) {
    extend(DocumentListView, superClass);
